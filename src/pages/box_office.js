    ...
    <Layout>
      <div className="mx-4">
        ...
        <h2 className="text-3xl font-extrabold">
          I need your guys with filler Content here.
        </h2>
        <p>
          These are the remaining shows for the Season. We need some fun helpful
          information to go along with these guys.
        </p>
              ...
              <div className="text-center md:text-left mx-6 my-4">
                ...
                <div className="mt-4 flex justify-between">
                  {edge.node.showTime.map(show => {
                    return (
                      <div
                        className="flex flex-col pt-1 uppercase font-semibold text-purple-500 text-xs"
                        key={show.eventTime}
                      >
                        ...
                        <a
                          ...
                          className="rounded-lg px-1 py-1 bg-nfhspurple text-white text-center text-xs mt-2 mx-2"
                        >
                          {show.ticketUrl
                            ? "Buy Tickets"
                            : "Tickets Unavailable"}
